<center>
<!-- <a href="" title="Role" class="btn btn-success btn-xs">
    <i class="fa fa-user"></i> 
</a>
<a href="" title="Permission" class="btn btn-warning btn-xs">
    <i class="fa fa-key"></i> 
</a> -->
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-8">
                        @if($active == 0) : <label for="" class="label label-danger">Non-Aktif</label> @endif
                        @if($active == 1) : <label for="" class="label label-success">Aktif</label> @endif
                            <p class="text-danger"></p>
                        </div>      
                        <div class="col-sm-4">
