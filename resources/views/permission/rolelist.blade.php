...
@section('title')
{{ config('app.name') }} | Permission Role List 
@endsection
...
<div class="content-wrapper"> 
    ...
    <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="m-0">Permission Role List</h1><br>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" ><a href="#">Permission Role List</a> </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card card-danger card-outline">
                        <div class="card-header">
                            <h3 class="card-title">List Role yang mempunyai permission <strong>{{ $permission->name }}</strong></h3>
                            <button type="button" class="btn btn-success float-sm-right" data-toggle="modal" data-target="#tambahRole">
                                        ...
                                        <form action="{{ route('permission.role.add', $permission->id) }}" method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <select name="role[]" class="form-select select2" id="role_id" data-live-search="true" multiple>
